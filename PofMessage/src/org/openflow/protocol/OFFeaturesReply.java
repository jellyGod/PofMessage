...
public class OFFeaturesReply extends OFMessage {
    ...
    public void readFrom(ByteBuffer data) {
        ...
        this.portNum = data.getShort();
        this.tableNum = data.getShort();
    ...
    public void writeTo(ByteBuffer data) {
        ...
        data.putShort(this.portNum);
        data.putShort(this.tableNum);
        
        data.putInt(this.capabilities);
        data.putInt(0);
        
        data.put(ParseString.NameStringToBytes(experimenterName));
        data.put(ParseString.NameStringToBytes(deviceForwardEngineName));
        data.put(ParseString.NameStringToBytes(deviceLookupEngineName));
    }
