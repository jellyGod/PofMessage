...
//        },
    ...
    public void writeTo(ByteBuffer data) {
        data.putInt(this.portId);
        data.putInt(this.deviceId);
        data.put(this.hardwareAddress);
        data.put(new byte[2]);
        
        data.put(ParseString.NameStringToBytes(this.name));
